...
@interface PSPlatMessageViewModel ()

@property (nonatomic, strong) PSPlatMessageRequest *familyLogsRequest;
@property (nonatomic, strong) NSMutableArray *logs;

@end

@implementation PSPlatMessageViewModel
...
- (void)requestMessagesCompleted:(RequestDataCompleted)completedCallback failed:(RequestDataFailed)failedCallback {
    self.familyLogsRequest = [PSPlatMessageRequest new];
