...
- (NSArray *)setArrayChildVCs {
    _ArticleVC = [[InteractiveArticleViewController alloc] init];
    _CollectionVC = [[CollectionArtcleViewController alloc] init];
    _MineArticleVC = [[MineArticleViewController alloc] init];
