...
- (void)setupUI {
    ...
    self.lawyerMoneyLab.frame=CGRectMake(SCREEN_WIDTH-110, _moneyLab.y, 66, 12);
...
- (UIButton *)chatBtn {
    if (!_chatBtn) {
        ...
        _chatBtn.titleLabel.textColor = [UIColor whiteColor];
...
-(UILabel *)detailLab {
    if (!_detailLab) {
        ...
        _detailLab.textColor = UIColorFromRGB(38,76, 144);
