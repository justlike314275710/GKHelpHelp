...
- (void)setupUI {
    ...
    CGFloat SHeight = 90;
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0,15, SCREEN_WIDTH, SHeight)];
    ...
    self.stateImg.frame = CGRectMake(SCREEN_WIDTH-60,0,60, 50);
...
//    self.chatBtn.frame = CGRectMake(KScreenWidth-90,self.stateImg.bottom,66,24);
    ...
    self.detailLab.frame = CGRectMake(SCREEN_WIDTH-120,_timeLab.bottom,100,20);
    
    
    [bgView addSubview:self.chatBtn];
    self.chatBtn.frame = CGRectMake(SCREEN_WIDTH-90,_timeLab.bottom-3,66,24);

     [bgView addSubview:self.lawyerMoneyLab];
    self.lawyerMoneyLab.frame=CGRectMake(SCREEN_WIDTH-90, _moneyLab.y, 66, 12);
...
- (UIButton *)chatBtn {
    if (!_chatBtn) {
        ...
        _chatBtn.titleLabel.textColor = UIColorFromRGB(255, 255, 255);
        _chatBtn.titleLabel.font = FontOfSize(10);
    }
    return _chatBtn;
}
...
-(UILabel *)detailLab {
    if (!_detailLab) {
        ...
        _detailLab.textColor = UIColorFromRGB(36,108,144);
